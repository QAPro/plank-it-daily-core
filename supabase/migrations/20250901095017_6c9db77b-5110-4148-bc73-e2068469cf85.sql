...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_sessions_user_exercise 
ON user_sessions(user_id, exercise_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_sessions_user_duration 
ON user_sessions(user_id, duration_seconds);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_sessions_user_completed 
ON user_sessions(user_id, completed_at);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_achievement_progress_user_updated 
ON user_achievement_progress(user_id, last_updated);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_achievements_user_type 
