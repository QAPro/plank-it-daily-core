...
CREATE INDEX idx_friend_activities_user_id ON public.friend_activities(user_id);
CREATE INDEX idx_friend_activities_created_at ON public.friend_activities(created_at DESC);
CREATE INDEX idx_friend_activities_visibility ON public.friend_activities(visibility);
CREATE INDEX idx_friend_reactions_activity_id ON public.friend_reactions(activity_id);
