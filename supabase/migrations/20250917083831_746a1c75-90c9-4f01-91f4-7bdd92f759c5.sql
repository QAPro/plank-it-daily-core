-- Update existing standing_movement exercises with rich metadata (using correct column names)
...
SET 
  ...
  primary_muscles = ARRAY['hamstrings', 'lower_back', 'calves'],
...
SET 
  ...
  primary_muscles = ARRAY['obliques', 'intercostals', 'latissimus_dorsi'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['erector_spinae', 'chest', 'hip_flexors'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['chest', 'anterior_deltoids', 'biceps'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['hip_flexors', 'psoas', 'quadriceps'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['quadriceps', 'hip_flexors'],
...
SET 
  ...
  primary_muscles = ARRAY['gastrocnemius', 'soleus', 'achilles'],
  equipment_needed = ARRAY['wall_support'],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['obliques', 'erector_spinae', 'deep_spinal_rotators'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['trapezius', 'rhomboids', 'deltoids'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['sternocleidomastoid', 'upper_trapezius', 'levator_scapulae'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
  tags = ARRAY['flexibility', 'neck_stretch', 'tension_relief', 'posture', 'beginner_friendly'],
  estimated_calories_per_minute = 1.0,
...
SET 
  ...
  primary_muscles = ARRAY['deltoids', 'rotator_cuff', 'rhomboids'],
  equipment_needed = ARRAY[]::text[],
  is_beginner_friendly = true,
...
SET 
  ...
  primary_muscles = ARRAY['piriformis', 'glutes', 'hip_external_rotators'],
  equipment_needed = ARRAY['wall_support'],
